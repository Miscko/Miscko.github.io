        ...
        function i(e, i) {
          for (var a = {}, n = [], o = 0; o < e.length; o++) {
            ...
            if (-1 !== u) t[u].references++, t[u].updater(m);
              ...
              var h = r(m, i);
              (i.byIndex = o),
                t.splice(o, 0, { identifier: c, updater: h, references: 1 });
            }
            n.push(c);
          }
          return n;
    ...
    (function () {
            ...
            for (let t = 0, i = s.length; t < i; t += 1) {
              ...
              void 0 !== a &&
                ...
                (c(e[i]) && c(r[i])
                  ...
                  : !c(e[i]) && c(r[i])
                    ? ((e[i] = {}),
                      r[i].__swiper__ ? (e[i] = r[i]) : u(e[i], r[i]))
                    : (e[i] = r[i]));
            }
          }
        }
      ...
      var N = {
        ...
        updateActiveIndex: function (e) {
          ...
          let u;
          if (t.virtual && r.virtual.enabled && r.loop) u = p(d);
          else if (c) {
      ...
      var R = {
          slideTo: function (e, t, s, i, r) {
            ...
            const x = I().isSafari;
            return (
              y && !r && x && a.isElement && a.virtual.update(!1, !1, n),
              a.setTransition(t),
              a.setTranslate(w),
              a.updateActiveIndex(n),
              a.updateSlidesClasses(),
        ...
        X = {
          ...
          loopFix: function (e) {
            ...
            let L = 0,
              z = 0;
            const k =
              (x ? p[a].column : a) + (f && void 0 === r ? -w / 2 + 0.5 : 0);
            if (k < y) {
              L = Math.max(y - k, b);
              ...
              (z = Math.max(k - (T - 2 * y), b)),
                A && (z = Math.max(z, w - T + g + 1));
              for (let e = 0; e < z; e += 1) {
                const t = e - Math.floor(e / T) * T;
                x
                  ? p.forEach((e, s) => {
      ...
      function q(e) {
        ...
        c.matches(a.focusableElements) &&
          ...
          s.activeElement &&
            ...
            s.activeElement !== c &&
            ("mouse" === i.pointerType ||
              ("mouse" !== i.pointerType && !c.matches(a.focusableElements))) &&
      ...
      function V(e) {
        const t = r(),
          s = this,
          i = s.touchEventsData,
          { params: a, touches: n, rtlTranslate: o, enabled: l } = s;
        if (!l) return;
      ...
      function j(e) {
        ...
        if (m > a.longSwipesMs) {
          ...
          "next" === t.swipeDirection &&
            (y >= a.longSwipesRatio
              ? t.slideTo(a.rewind && t.isEnd ? w : g + x)
              : t.slideTo(g)),
      ...
      const K = (e, t) => {
        const s = r(),
          { params: i, el: a, wrapperEl: n, device: o } = e,
          l = !!i.nested,
      ...
      class re {
        ...
        slidesPerViewDynamic(e, t) {
          ...
          else for (let e = o - 1; e >= 0; e -= 1) r[o] - r[e] < n && (l += 1);
          return l;
        }
        update() {
          const e = this;
          ...
          e.params.createElements &&
            Object.keys(i).forEach((r) => {
              if (!s[r] && !0 === s.auto) {
                let a = g(e.el, `.${i[r]}`)[0];
                a ||
                  ((a = w("div", i[r])), (a.className = i[r]), e.el.append(a)),
                  (s[r] = a),
                  (t[r] = a);
              }
            }),
      ...
      const ge = [
        function (e) {
          ...
          function p(e, t, i) {
            ...
            (y = s.rtlTranslate ? "right" : s.isHorizontal() ? "left" : "top"),
              o
                ? ((x = Math.floor(r / 2) + a + u),
                  (E = Math.floor(r / 2) + a + c))
                : ((x = r + (a - 1) + u), (E = (l ? r : a) + c));
            let S = b - E,
              T = b + x;
            l || ((S = Math.max(S, 0)), (T = Math.min(T, f.length - 1)));
            let A = (s.slidesGrid[S] || 0) - (s.slidesGrid[0] || 0);
            function M() {
              s.updateSlides(),
                s.updateProgress(),
                s.updateSlidesClasses(),
            ...
            if (
              (l && b >= E
                ? ((S -= E), o || (A += s.slidesGrid[0]))
                : l && b < E && ((S = -E), o && (A += s.slidesGrid[0])),
              ...
              return (
                s.slidesGrid !== v &&
                  A !== w &&
                  s.slides.forEach((e) => {
                    e.style[y] = A - Math.abs(s.cssOverflowAdjustment()) + "px";
                  }),
                s.updateProgress(),
            ...
            const z = l ? -f.length : 0,
              k = l ? 2 * f.length : f.length;
            for (let t = z; t < k; t += 1)
              if (t >= S && t <= T) {
                const s = L(t);
                void 0 === h || e
                  ? P.push(s)
                  : (t > h && P.push(s), t < m && C.push(s));
              }
            if (
              (P.forEach((e) => {
          ...
          function f(e) {
            return !(
              ...
              (t.params.mousewheel.thresholdTime &&
                d() - c < t.params.mousewheel.thresholdTime) ||
              (!(e.delta >= 6 && d() - c < 60) &&
                (e.direction < 0
        ...
        function (e) {
          ...
          function c() {
            ...
            if (
              ...
              if (
                (s.dynamicBullets &&
                  ((n = T(r[0], t.isHorizontal() ? "width" : "height", !0)),
                  p.forEach((e) => {
                  ...
                  s.dynamicMainBullets > 1 &&
                    ...
                    o > s.dynamicMainBullets - 1
                      ...
                      : o < 0 && (o = 0)),
                  (l = Math.max(i - o, 0)),
                  (c = l + (Math.min(r.length, s.dynamicMainBullets) - 1)),
                  (u = (c + l) / 2)),
                r.forEach((e) => {
                  const t = [
                    ...[
        ...
        function (e) {
          ...
          function C() {
            ...
            t.params.uniqueNavElements &&
              ...
              r &&
                ((a = r.querySelector(ne(t.params.scrollbar.dragClass))),
                a ||
                  ((a = w("div", t.params.scrollbar.dragClass)), r.append(a))),
          ...
          const r =
            ...
            n = () => {
              const {
                ...
                l = g(e, r);
              t.isElement && l.push(...g(t.hostEl, r)),
                l.forEach((e) => {
                  a(e, i);
                }),
                s.forEach((e, s) => {
        ...
        function (e) {
          ...
          function P(e) {
            if (("mouse" === e.pointerType && f.splice(0, f.length), !M(e)))
              return;
            const s = t.params.zoom;
            if (((m = !1), (h = !1), f.push(e), !(f.length < 2))) {
          ...
          function I(e) {
            ...
            const i = t.zoom;
            if (!v.imageEl) return;
            if (!w.isTouched || !v.slideEl) return void (s && D(e));
            if (s) return void D(e);
            w.isMoved ||
              ((w.width = v.imageEl.offsetWidth || v.imageEl.clientWidth),
              (w.height = v.imageEl.offsetHeight || v.imageEl.clientHeight),
              (w.startX = p(v.imageWrapEl, "x") || 0),
              (w.startY = p(v.imageWrapEl, "y") || 0),
            ...
            if (
              ...
              (w.maxX = -w.minX),
              (w.minY = Math.min(v.slideHeight / 2 - a / 2, 0)),
              (w.maxY = -w.minY),
              (w.touchesCurrent.x = f.length > 0 ? f[0].pageX : e.pageX),
              (w.touchesCurrent.y = f.length > 0 ? f[0].pageY : e.pageY),
              Math.max(
            ...
            e.cancelable && e.preventDefault(),
              ...
              (w.isMoved = !0);
            const n = (i.scale - o) / (v.maxRatio - t.params.zoom.minRatio),
              { originX: d, originY: c } = v;
            (w.currentX =
              w.touchesCurrent.x -
              w.touchesStart.x +
              w.startX +
          ...
          function D(e) {
            ...
            const i = (e.clientX - c.x) * u,
              ...
              p = v.slideWidth,
              m = v.slideHeight,
              h = Math.min(p / 2 - n / 2, 0),
              f = -h,
              g = Math.min(m / 2 - l / 2, 0),
              b = -g,
              y = Math.max(Math.min(w.startX + i, f), h),
              x = Math.max(Math.min(w.startY + r, b), g);
            (v.imageWrapEl.style.transitionDuration = "0ms"),
          ...
          function $(e) {
            ...
            if (!v.slideEl) {
              ...
              s &&
                ...
                (v.imageEl = s),
                (v.imageWrapEl = s
                  ? E(v.imageEl, `.${i.containerClass}`)[0]
                  : void 0);
            }
            if (!v.imageEl || !v.imageWrapEl) return;
            let r, n, l, d, p, c, u, m, h, f, y, x, S, T, M, C, P, L;
            t.params.cssMode &&
              ((t.wrapperEl.style.overflow = "hidden"),
            ...
            (s.scale = k || I),
              ...
              !e || (1 === o && k)
                ...
                : ((P = v.slideEl.offsetWidth),
                  ...
                  (f = v.imageEl.offsetHeight || v.imageEl.clientHeight),
                  (y = h * s.scale),
                  (x = f * s.scale),
                  ...
                  z > 0 &&
                  k &&
                  "number" == typeof w.currentX &&
                  "number" == typeof w.currentY
                    ? ((u = (w.currentX * s.scale) / z),
                      (m = (w.currentY * s.scale) / z))
          ...
          function B() {
            ...
            v.imageEl &&
              ...
              t.params.zoom.panOnMouseMove &&
                ((c = { x: 0, y: 0 }),
                d && ((d = !1), (w.startX = 0), (w.startY = 0))));
          }
          function Y(e) {
            const s = t.zoom;
            s.scale && 1 !== s.scale ? B() : $(e);
          }
          function G() {
            return {
          ...
          Object.defineProperty(t.zoom, "scale", {
            ...
            i("touchEnd", (e, s) => {
              t.zoom.enabled &&
                (function () {
                  const e = t.zoom;
                  if (((f.length = 0), !v.imageEl)) return;
                  ...
                  const r = y.x * s,
                    ...
                    n = y.y * i,
                    o = w.currentY + n;
                  0 !== y.x && (s = Math.abs((a - w.currentX) / y.x)),
                    0 !== y.y && (i = Math.abs((o - w.currentY) / y.y));
                  const l = Math.max(s, i);
                  (w.currentX = a), (w.currentY = o);
                  const d = w.width * e.scale,
                    p = w.height * e.scale;
                  (w.minX = Math.min(v.slideWidth / 2 - d / 2, 0)),
                    (w.maxX = -w.minX),
                    (w.minY = Math.min(v.slideHeight / 2 - p / 2, 0)),
                    (w.maxY = -w.minY),
                    (w.currentX = Math.max(
                      Math.min(w.currentX, w.maxX),
                      w.minX,
                    )),
                    (w.currentY = Math.max(
                      Math.min(w.currentY, w.maxY),
                      w.minY,
                    )),
                ...
                function l(e) {
                  ...
                  "slide" === t.params.controller.by &&
                    ...
                    (n && "container" !== t.params.controller.by) ||
                      ...
                      (n = (s - t.minTranslate()) * a + e.minTranslate())),
        ...
        function (e) {
          ...
          function v(e) {
            ...
            if (
              ...
              if (t.navigation && t.navigation.prevEl && t.navigation.nextEl) {
                ...
                A(t.navigation.nextEl).includes(i) &&
          ...
          const E = (e, t, s) => {
            ...
            S = (e) => {
              n && n !== e.target && !n.contains(e.target) && (a = !0),
                (t.a11y.clicked = !0);
            },
            T = () => {
              (a = !1),
          ...
          i("beforeInit", () => {
            (o = w("span", t.params.a11y.notificationClass)),
            ...
            i("afterInit", () => {
              t.params.a11y.enabled &&
                (() => {
                  ...
                  (p = A(p)),
                    (c = A(c)),
                    p && p.forEach((t) => E(t, a, e.nextSlideMessage)),
                    c && c.forEach((t) => E(t, a, e.prevSlideMessage)),
                    y() &&
              ...
              (() => {
                ...
                if (t.params.history) {
                  ...
                  (r = !0),
                    (a = l(t.params.url)),
                    a.key || a.value
                      ? (p(0, a.value, t.params.runCallbacksOnInit),
                        t.params.history.replaceState ||
        ...
        function (e) {
          let t,
            s,
            { swiper: i, extendParams: a, on: n, emit: o, params: l } = e;
          ...
          const x = () => {
                  ...
                  i &&
                    ...
                    (i.params.autoplay.reverseDirection
                      ? !i.isBeginning || i.params.loop || i.params.rewind
                        ? (i.slidePrev(n, !0, !0), o("autoplay"))
                        : i.params.autoplay.stopOnLastSlide ||
                          (i.slideTo(i.slides.length - 1, n, !0, !0),
                          o("autoplay"))
                      : !i.isEnd || i.params.loop || i.params.rewind
                        ? (i.slideNext(n, !0, !0), o("autoplay"))
                        : i.params.autoplay.stopOnLastSlide ||
                          (i.slideTo(0, n, !0, !0), o("autoplay")),
                    i.params.cssMode &&
                      ((b = new Date().getTime()),
                      requestAnimationFrame(() => {
                        E();
            ...
            A = (e, s) => {
              ...
              if (((i.autoplay.paused = !0), s))
                return h && (d = i.params.autoplay.delay), (h = !1), void r();
              const a = d || i.params.autoplay.delay;
              (d = a - (new Date().getTime() - b)),
                (i.isEnd && d < 0 && !i.params.loop) || (d < 0 && (d = 0), r());
            },
            M = () => {
            ...
            P = (e) => {
              "mouse" === e.pointerType &&
                ((f = !0), (g = !0), i.animating || i.autoplay.paused || A(!0));
            },
            L = (e) => {
                      ...
                      if (p.velocities.length > 1) {
                        ...
                        (t.velocity = i / r),
                          ...
                          Math.abs(t.velocity) < a.freeMode.minimumVelocity &&
                            (t.velocity = 0),
                          (r > 150 || d() - e.time > 300) && (t.velocity = 0);
                      } else t.velocity = 0;
        ...
        function (e) {
          let t,
            ...
            i,
            r,
            { swiper: a, extendParams: n, on: o } = e;
                ...
                const { slidesPerView: r } = a.params,
                  ...
                  l =
                    a.virtual && a.params.virtual.enabled
                      ...
                      : e.length;
                (i = Math.floor(l / n)),
                  (t = Math.floor(l / n) === l / n ? l : Math.ceil(l / n) * n),
                  "auto" !== r && "row" === o && (t = Math.max(t, r * n)),
                  (s = t / n);
              },
              unsetSlides: () => {
                a.slides &&
              ...
              updateSlide: (e, r, n) => {
                ...
                if ("row" === c && o > 1) {
                  const s = Math.floor(e / (o * p)),
                    i = e - p * o * s,
                    a =
                      0 === s ? o : Math.min(Math.ceil((u - s * p * o) / p), o);
                  (f = Math.floor(i / a)),
                    (h = i - f * a + s * o),
                    (m = h + (f * t) / p),
                    (r.style.order = m);
                ...
                (r.row = f),
                  (r.column = h),
                  (r.style.height = `calc((100% - ${(p - 1) * d}px) / ${p})`),
                  (r.style[a.getDirectionLabel("margin-top")] =
                    0 !== f ? d && `${d}px` : ""),
              ...
              for (let e = 0; e < i.length; e += 1) {
                ...
                s % 4 == 0
                  ...
                  : (s - 1) % 4 == 0
                    ...
                    : (s - 2) % 4 == 0
                      ? ((h = l + 4 * n * l), (v = l))
                      : (s - 3) % 4 == 0 && ((h = -l), (v = 3 * l + 4 * l * n)),
                  o && (h = -h),
                  u || ((g = h), (h = 0));
                const w = `rotateX(${p(u ? 0 : -a)}deg) rotateY(${p(u ? a : 0)}deg) translate3d(${h}px, ${g}px, ${v}px)`;
                d <= 1 &&
                  d > -1 &&
                  ((f = 90 * s + 90 * d), o && (f = 90 * -s - 90 * d)),
                  (t.style.transform = w),
                  c.slideShadows && r(t, d, u);
              }
              if (
          ...
          ue({
            ...
            setTranslate: () => {
              ...
              for (let n = 0; n < e.length; n += 1) {
                ...
                const h = `translate3d(${u}px, ${m}px, 0px) rotateX(${a(c)}deg) rotateY(${a(p)}deg)`;
                me(0, o).style.transform = h;
              }
            },
            setTransition: (e) => {
              const s = t.slides.map((e) => f(e));
            ...
            setTranslate: () => {
              ...
              for (let s = 0; s < e.length; s += 1) {
                ...
                p < 0
                  ...
                  m.forEach((e, t) => {
                    m[t] =
                      `calc(${e}px + (${r(g.translate[t])} * ${Math.abs(p * n)}))`;
                  }),
                  h.forEach((e, t) => {
                ...
                const v = m.join(", "),
                  w = `rotateX(${l(h[0])}deg) rotateY(${l(h[1])}deg) rotateZ(${l(h[2])}deg)`,
                  b =
                    c < 0
              ...
              setTranslate: () => {
                ...
                for (let l = 0; l < e.length; l += 1) {
                  ...
                  let g = 1,
                    ...
                    w = r.perSlideOffset - 0.75 * Math.abs(c);
                  const b =
                      t.virtual && t.params.virtual.enabled
                        ? t.virtual.from + l
                        : l,
      ...
      (ze.styleTagTransform = Pe()),
        (ze.setAttributes = Te()),
        (ze.insert = Ee().bind(null, "head")),
        (ze.domAPI = ye()),
        (ze.insertStyleElement = Me()),
        we()(Le.Z, ze),
        Le.Z && Le.Z.locals && Le.Z.locals,
        (function () {
          const e = document.querySelector(".mobile-nav-btn"),
            t = document.querySelector(".mobile-nav"),
            s = document.querySelector(".nav-icon");
          e.onclick = function () {
            t.classList.toggle("mobile-nav--open"),
              s.classList.toggle("nav-icon--active"),
              document.body.classList.toggle("no-scroll");
          };
        })();
      const ke = document.querySelector(".header__btn"),
        Ie = document.querySelector(".header-rightside"),
        Oe = document.querySelector(".mask"),
        De = document.querySelector(".rightside-close");
      function $e() {
      ...
      const Be = document.querySelector(".btn-login"),
        Ye = document.querySelector(".btn-signup"),
        Ge = document.querySelector(".modal-login"),
        Ne = document.querySelector(".modal-signup"),
        He = document.querySelector(".modal-close--login"),
        Re = document.querySelector(".modal-close--signup");
      Be.addEventListener("click", () => {
        Ge.classList.toggle("modal-login--active");
      }),
        Ye.addEventListener("click", () => {
          Ne.classList.toggle("modal-signup--active");
        }),
        He.addEventListener("click", () => {
          (parent = He.closest(".modal-overlay")),
            parent.classList.toggle("modal-login--active");
        }),
        Re.addEventListener("click", () => {
          (parent = Re.closest(".modal-overlay")),
            console.log(parent),
            parent.classList.remove("modal-signup--active");
        });
    })();
})();
